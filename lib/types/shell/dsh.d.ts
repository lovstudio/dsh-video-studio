...
export type Selector<T> = <R>(select: (value: T) => R, equal?: (left: R, right: R) => boolean) => R;
...
export declare function appendStudioDraft(draft: string, text: string): string;
/** Mirrors DSH's public conversationPhase rule without plugin-to-plugin value imports. */
export declare function isBlankConversation(session: SessionSnapshot, activeTargets: ReadonlySet<string>): boolean;
