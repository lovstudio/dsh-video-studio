...
(self["webpackChunk_lovstudio_dsh_video_studio"] =
  ...
  {
    /***/
    4479(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _chunk_6jf1natv_js__WEBPACK_IMPORTED_MODULE_0__ =
      ...
      var require_lib = __commonJS((exports) => {
        ...
        var toNodeDescription = ({ type, prefix: prefix2 }) =>
          type === "UpdateExpression"
            ? NodeDescriptions.UpdateExpression[String(prefix2)]
            : NodeDescriptions[type];
        var StandardErrors = {
          AccessorIsGenerator: ({ kind }) =>
            "A ".concat(kind, "ter cannot be a generator."),
          ArgumentsInClass:
          ...
          DeclarationMissingInitializer: ({ kind }) =>
            "Missing initializer in ".concat(kind, " declaration."),
          ...
          DynamicImportPhaseRequiresImportExpressions: ({ phase }) =>
            "'import.".concat(
              phase,
              "(...)' can only be parsed when using the 'createImportExpressions' option.",
            ),
          ...
          ExportBindingIsString: ({ localName, exportName }) =>
            "A string literal cannot be used as an exported binding without `from`.\n- Did you mean `export { '"
              .concat(localName, "' as '")
              .concat(exportName, "' } from 'some-module'`?"),
          ...
          IllegalBreakContinue: ({ type }) =>
            "Unsyntactic ".concat(
              type === "BreakStatement" ? "break" : "continue",
              ".",
            ),
          ...
          ImportCallArity: ({ maxArgumentCount }) =>
            "`import()` requires exactly ".concat(
          ...
          InvalidDigit: ({ radix }) =>
            "Expected number in radix ".concat(radix, "."),
          InvalidEscapeSequence: "Bad character escape sequence.",
          InvalidEscapeSequenceTemplate: "Invalid escape sequence in template.",
          InvalidEscapedReservedWord: ({ reservedWord }) =>
            "Escape sequence in keyword ".concat(reservedWord, "."),
          InvalidIdentifier: ({ identifierName }) =>
            "Invalid identifier ".concat(identifierName, "."),
          InvalidLhs: ({ ancestor }) =>
            "Invalid left-hand side in ".concat(
              toNodeDescription(ancestor),
              ".",
            ),
          ...
          InvalidLhsOptionalChaining: ({ ancestor }) =>
            "Invalid optional chaining in the left-hand side of ".concat(
              toNodeDescription(ancestor),
              ".",
            ),
          ...
          ModuleExportNameHasLoneSurrogate: ({ surrogateCharCode }) =>
            "An export name cannot include a lone surrogate, found '\\u".concat(
              surrogateCharCode.toString(16),
              "'.",
            ),
          ModuleExportUndefined: ({ localName }) =>
            "Export '".concat(localName, "' is not defined."),
          ...
          PrivateInExpectedIn: ({ identifierName }) =>
            "Private names are only allowed in property accesses (`obj.#"
              .concat(identifierName, "`) or in `in` expressions (`#")
              .concat(identifierName, " in obj`)."),
          PrivateNameRedeclaration: ({ identifierName }) =>
            "Duplicate private name #".concat(identifierName, "."),
          ...
          UnexpectedKeyword: ({ keyword }) =>
            "Unexpected keyword '".concat(keyword, "'."),
          ...
          UnexpectedReservedWord: ({ reservedWord }) =>
            "Unexpected reserved word '".concat(reservedWord, "'."),
          UnexpectedSuper:
            "'super' is only allowed in object methods and classes.",
          UnexpectedToken: ({ expected, unexpected }) =>
            "Unexpected token"
              .concat(unexpected ? " '".concat(unexpected, "'.") : "")
              .concat(expected ? ', expected "'.concat(expected, '"') : ""),
        ...
        var StrictModeErrors = {
          ...
          StrictEvalArguments: ({ referenceName }) =>
            "Assigning to '".concat(referenceName, "' in strict mode."),
          StrictEvalArgumentsBinding: ({ bindingName }) =>
            "Binding '".concat(bindingName, "' in strict mode."),
          StrictFunction:
        ...
        var PipelineOperatorErrors = {
          ...
          PipeUnparenthesizedBody: ({ type }) =>
            "Hack-style pipe body cannot be an unparenthesized ".concat(
              toNodeDescription({
                type,
              }),
        ...
        var Errors = Object.assign(
          ...
          ParseErrorEnum(_a || (_a = __template(["pipelineOperator"])))(
        ...
        function createToken(name, options = {}) {
          ...
          tokenPrefixes.push(
            (_options$prefix = options.prefix) != null
              ? _options$prefix
              : false,
          );
        ...
        function isIdentifierStart(code2) {
          ...
          if (code2 <= 65535) {
            return (
              code2 >= 170 &&
              nonASCIIidentifierStart.test(String.fromCharCode(code2))
            );
          }
        ...
        function isIdentifierChar(code2) {
          ...
          if (code2 <= 65535) {
            return (
              code2 >= 170 &&
              nonASCIIidentifier.test(String.fromCharCode(code2))
            );
          }
          return (
        ...
        function isStringEnd(type, ch, input, pos) {
          if (type === "template") {
            return (
              ch === 96 || (ch === 36 && input.charCodeAt(pos + 1) === 123)
            );
          }
        ...
        class Tokenizer extends CommentsParser {
          ...
          readCodePoint(throwOnInvalid) {
            const { code: code2, pos } = readCodePoint(
              this.input,
              this.state.pos,
              this.state.lineStart,
              this.state.curLine,
        ...
        var FlowErrors = ParseErrorEnum(_b || (_b = __template(["flow"])))({
          AmbiguousConditionalArrow:
            "Ambiguous expression: wrap the arrow functions in parentheses to disambiguate.",
          AmbiguousDeclareModuleKind:
            "Found both `declare module.exports` and `declare export` in the same module. Modules can only have 1 since they are either an ES module or they are a CommonJS module.",
          AssignReservedType: ({ reservedType }) =>
            "Cannot overwrite reserved type ".concat(reservedType, "."),
          DeclareClassElement:
          ...
          EnumBooleanMemberNotInitialized: ({ memberName, enumName }) =>
            "Boolean enum members need to be initialized. Use either `"
              .concat(memberName, " = true,` or `")
              .concat(memberName, " = false,` in enum `")
              .concat(enumName, "`."),
          EnumDuplicateMemberName: ({ memberName, enumName }) =>
            "Enum member names need to be unique, but the name `"
              .concat(memberName, "` has already been used before in enum `")
              .concat(enumName, "`."),
          ...
          EnumInvalidExplicitTypeUnknownSupplied: ({ enumName }) =>
            "Supplied enum type is not valid. Use one of `boolean`, `number`, `string`, or `symbol` in enum `".concat(
              enumName,
              "`.",
            ),
          EnumInvalidMemberInitializerPrimaryType: ({
            ...
            "Enum `"
              .concat(enumName, "` has type `")
              .concat(explicitType, "`, so the initializer of `")
              .concat(memberName, "` needs to be a ")
              .concat(explicitType, " literal."),
          EnumInvalidMemberInitializerSymbolType: ({ enumName, memberName }) =>
            "Symbol enum members cannot be initialized. Use `"
              .concat(memberName, ",` in enum `")
              .concat(enumName, "`."),
          ...
          EnumInvalidMemberName: ({ enumName, memberName, suggestion }) =>
            "Enum member names cannot start with lowercase 'a' through 'z'. Instead of using `"
              .concat(memberName, "`, consider using `")
              .concat(suggestion, "`, in enum `")
              .concat(enumName, "`."),
          EnumNumberMemberNotInitialized: ({ enumName, memberName }) =>
            "Number enum members need to be initialized, e.g. `"
              .concat(memberName, " = 1` in enum `")
              .concat(enumName, "`."),
          EnumStringMemberInconsistentlyInitialized: ({ enumName }) =>
            "String enum members need to consistently either all use initializers, or use no initializers, in enum `".concat(
              enumName,
              "`.",
            ),
          ...
          UnexpectedReservedType: ({ reservedType }) =>
            "Unexpected reserved type ".concat(reservedType, "."),
          ...
          UnsupportedDeclareExportKind: ({
            ...
            "`declare export "
              .concat(unsupportedExportKind, "` is not supported. Use `")
              .concat(suggestion, "` instead."),
        ...
        var flow = (superClass) =>
          class FlowParserMixin extends superClass {
            ...
            parseConditional(expr, startLoc, refExpressionErrors) {
              ...
              if (failed || invalid.length > 0) {
                ...
                if (failed && valid.length > 1) {
                  this.raise(
                    FlowErrors.AmbiguousConditionalArrow,
                    state.startLoc,
                  );
                }
                if (failed && valid.length === 1) {
            ...
            getArrowLikeExpressions(node, disallowInvalid) {
              ...
              return partition(arrows, (node2) =>
                node2.params.every((param) => this.isAssignable(param, true)),
              );
            }
            ...
            parseMaybeAssign(refExpressionErrors, afterLeftParse) {
              ...
              if (((_jsx = jsx2) != null && _jsx.error) || this.match(47)) {
                ...
                const arrow = this.tryParse((abort) => {
                  ...
                  if (
                    (_arrowExpression$extr = arrowExpression2.extra) != null &&
                    _arrowExpression$extr.parenthesized
                  )
                    abort();
                  const expr =
                    this.maybeUnwrapTypeCastExpression(arrowExpression2);
        ...
        var JsxErrors = ParseErrorEnum(_c || (_c = __template(["jsx"])))({
          AttributeIsEmpty:
            "JSX attributes must only be assigned a non-empty expression.",
          MissingClosingTagElement: ({ openingTagName }) =>
            "Expected corresponding JSX closing tag for <".concat(
              openingTagName,
              ">.",
            ),
          ...
          UnexpectedToken: ({ unexpected, HTMLEntity }) =>
            "Unexpected token `"
              .concat(unexpected, "`. Did you mean `")
              .concat(HTMLEntity, "` or `{'")
              .concat(unexpected, "'}`?"),
          UnsupportedJsxValue:
          ...
          class JSXParserMixin extends superClass {
                ...
                contents: for (;;) {
                  switch (this.state.type) {
                    case 142:
                      ...
                      if (this.eat(56)) {
                        closingElement =
                          this.jsxParseClosingElementAt(startLoc);
                        break contents;
                      }
                    ...
                    case 5: {
                      ...
                      if (this.match(21)) {
                        ...
                        children.push(
                          this.jsxParseExpressionContainer(node2, types.j_expr),
                        );
                      }
                      break;
                    }
                ...
                if (
                  ...
                  if (
                    ...
                    this.raise(
                      ...
                      closingElement,
                      {
                        openingTagName: getQualifiedJSXName(
                          openingElement.name,
                        ),
                      },
                    );
            ...
            updateContext(prevType) {
              ...
              if (type === 56 && prevType === 142) {
                ...
                this.state.canStartJSXElement =
                  tokenComesBeforeExpression(type);
              }
            }
          };
        ...
        var TSErrors = ParseErrorEnum(_d || (_d = __template(["typescript"])))({
          ...
          DeclareAccessor: ({ kind }) =>
            "'declare' is not allowed in ".concat(kind, "ters."),
          ...
          DuplicateModifier: ({ modifier }) =>
            "Duplicate modifier: '".concat(modifier, "'."),
          EmptyHeritageClauseType: ({ token }) =>
            "'".concat(token, "' list cannot be empty."),
          ...
          IncompatibleModifiers: ({ modifiers }) =>
            "'"
              .concat(modifiers[0], "' modifier cannot be used with '")
              .concat(modifiers[1], "' modifier."),
          ...
          InvalidModifierOnTypeMember: ({ modifier }) =>
            "'".concat(modifier, "' modifier cannot appear on a type member."),
          ...
          InvalidModifiersOrder: ({ orderedModifiers }) =>
            "'"
              .concat(orderedModifiers[0], "' modifier must precede '")
              .concat(orderedModifiers[1], "' modifier."),
          ...
          SingleTypeParameterWithoutTrailingComma: ({ typeParameterName }) =>
            "Single type parameter "
              .concat(
                typeParameterName,
                " should have a trailing comma. Example usage: <",
              )
              .concat(typeParameterName, ",>."),
          ...
          UnsupportedSignatureParameterKind: ({ type }) =>
            "Name in a signature must be an Identifier, ObjectPattern or ArrayPattern, instead got ".concat(
              type,
              ".",
            ),
        });
        ...
        var typescript = (superClass) =>
          class TypeScriptParserMixin extends superClass {
            ...
            tsParseMappedType() {
              ...
              node.nameType = this.eatContextual(93)
                ? this.tsParseType()
                : null;
              this.expect(3);
              if (this.match(53)) {
            ...
            tsParseTypeOperatorOrHigher() {
              const isTypeOperator =
                tokenIsTSTypeOperator(this.state.type) &&
              ...
              if (this.match(47) || this.match(51)) {
                ...
                const result = this.tsTryParseAndCatch(() => {
                  ...
                  if (tokenIsTemplate(this.state.type)) {
                    const result2 = super.parseTaggedTemplateExpression(
                      base,
                      startLoc,
                      state,
                    );
            ...
            parseExprOp(left, leftStartLoc, minPrec) {
              ...
              if (
                ...
                (this.isContextual(93) ||
                  (isSatisfies = this.isContextual(120)))
              ) {
            ...
            parseVarStatement(node, kind, allowMissingInitializer = false) {
              ...
              for (const { id, init } of declaration.declarations) {
                ...
                if (kind !== "const" || !!id.typeAnnotation) {
                  this.raise(
                    TSErrors.InitializerNotAllowedInAmbientContext,
                    init,
                  );
                } else if (
                  ...
                  this.state.startLoc,
                  {
                    propertyName:
                      key.type === "Identifier" && !node.computed
                        ? key.name
                        : "[".concat(this.input.slice(key.start, key.end), "]"),
                  },
                );
              }
              return super.parseClassProperty(node);
            ...
            parseMaybeAssign(refExpressionErrors, afterLeftParse) {
              ...
              throw (
                ((_jsx3 = jsx2) == null ? void 0 : _jsx3.error) ||
                arrow.error ||
            ...
            isClassProperty() {
              return (
                this.match(35) || this.match(14) || super.isClassProperty()
              );
            }
            parseMaybeDefault(startLoc, left) {
              const node = super.parseMaybeDefault(startLoc, left);
            ...
            toAssignableList(exprList, trailingCommaLoc, isLHS) {
              for (let i = 0; i < exprList.length; i++) {
                const expr = exprList[i];
                if (
                  (expr == null ? void 0 : expr.type) === "TSTypeCastExpression"
                ) {
                  exprList[i] = this.typeCastToParameter(expr);
                }
              }
        ...
        function isValidAmbientConstInitializer(expression, estree2) {
          ...
          if (
            isNumber(expression, estree2) ||
            isNegativeNumber(expression, estree2)
          ) {
            return true;
          }
          if (
        ...
        var PlaceholderErrors = ParseErrorEnum(
          _e || (_e = __template(["placeholders"])),
        )({
        ...
        var placeholders = (superClass) =>
          class PlaceholdersParserMixin extends superClass {
            ...
            maybeParseExportDefaultSpecifier(node, maybeDefaultIdentifier) {
              var _specifiers;
              if (
                (_specifiers = node.specifiers) != null &&
                _specifiers.length
              ) {
                return true;
              }
        ...
        function validatePlugins(plugins) {
          ...
          if (hasPlugin(plugins, "pipelineOperator")) {
            ...
            if (!PIPELINE_PROPOSALS.includes(proposal)) {
              const proposalList = PIPELINE_PROPOSALS.map((p) =>
                '"'.concat(p, '"'),
              ).join(", ");
              throw new Error(
            ...
            if (proposal === "hack") {
              ...
              if (!TOPIC_TOKENS.includes(topicToken)) {
                const tokenList = TOPIC_TOKENS.map((t) =>
                  '"'.concat(t, '"'),
                ).join(", ");
                throw new Error(
          ...
          if (
            ...
            throw new Error(
              "The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " +
                RECORD_AND_TUPLE_SYNTAX_TYPES.map((p) =>
                  "'".concat(p, "'"),
                ).join(", "),
            );
          }
        ...
        class ExpressionParser extends LValParser {
          ...
          setOptionalParametersError(refExpressionErrors, resultError) {
            ...
            refExpressionErrors.optionalParametersLoc =
              (_resultError$loc =
                resultError == null ? void 0 : resultError.loc) != null
                ? _resultError$loc
                : this.state.startLoc;
          }
          parseMaybeAssign(refExpressionErrors, afterLeftParse) {
          ...
          addTrailingCommaExtraToNode(node) {
            this.addExtra(
              node,
              "trailingComma",
              this.state.lastTokStartLoc.index,
            );
            this.addExtra(
              node,
              "trailingCommaLoc",
          ...
          parseMethod(
            ...
            const finishedNode = this.parseFunctionBodyAndFinish(
              node,
              type,
              true,
            );
            ...
            if (typeof type === "number") {
              {
                if (type === 138) {
                  ...
                  const hashEndLoc = createPositionWithColumnOffset(
                    loc.start,
                    1,
                  );
                  tokens.splice(
        ...
        class StatementParser extends ExpressionParser {
          ...
          parseBlockBody(
            ...
            this.parseBlockOrModuleBlockBody(
              body,
              allowDirectives ? directives : void 0,
              topLevel,
              end,
              afterBlockParse,
            );
          ...
          parseClassMemberWithIsStatic(classBody, member, state, isStatic) {
            ...
            if (this.isClassMethod()) {
              ...
              this.pushClassAccessorProperty(
                classBody,
                accessorProp,
                isPrivate2,
              );
          ...
          checkJSONModuleImport(node) {
            if (
              ...
              const { specifiers } = node;
              if (specifiers != null) {
                const nonDefaultNamedSpecifier = specifiers.find(
                  (specifier) => {
                    let imported;
            ...
            if (this.match(76)) {
              ...
              if (this.hasPlugin("importAttributes")) {
                if (
                  ...
                  this.raise(
                    Errors.ImportAttributesUseAssert,
                    this.state.startLoc,
                  );
                }
        ...
        function generateExportedTokenTypes(internalTokenTypes) {
          ...
          for (const typeName of Object.keys(internalTokenTypes)) {
            tokenTypes2[typeName] = getExportedToken(
              internalTokenTypes[typeName],
            );
          }
          return tokenTypes2;
        }
      ...
      var normalizePath = (input) => {
        ...
        return "".concat(hasLeadingSlash ? "/" : "").concat(parts.join("/"));
      };
      var getProjectFile = ({ filePath, project }) => {
        ...
        const candidates = [
          normalizedInput,
          normalizePath("/".concat(normalizedInput)),
          normalizePath(
            ""
              .concat(normalizedRoot, "/")
              .concat(normalizedInput.replace(/^\//, "")),
          ),
        ];
        ...
        const suffix = "/".concat(normalizedInput.replace(/^\//, ""));
        ...
        throw new Error('Could not find source file "'.concat(filePath, '"'));
      };
      var resolveImport = ({ fromFile, importPath, project }) => {
        if (!importPath.startsWith(".")) {
          throw new Error(
            'Cannot resolve package import "'.concat(importPath, '"'),
          );
        }
        const normalizedFrom = normalizePath(fromFile);
        const lastSlash = normalizedFrom.lastIndexOf("/");
        const directory =
          lastSlash === -1 ? "" : normalizedFrom.slice(0, lastSlash);
        const basePath = normalizePath(
          "".concat(directory, "/").concat(importPath),
        );
        const candidates = [
          basePath,
          ...[".tsx", ".ts", ".jsx", ".js"].map((extension) =>
            "".concat(basePath).concat(extension),
          ),
          ...[".tsx", ".ts", ".jsx", ".js"].map((extension) =>
            "".concat(basePath, "/index").concat(extension),
          ),
        ];
        const normalizedFiles = new Map(
          Object.keys(project.files).map((key) => [normalizePath(key), key]),
        ...
        throw new Error(
          'Could not find imported component file "'.concat(importPath, '"'),
        );
      };
      var jsxName = (name) => {
      ...
      var resolveDeclaration = ({ filePath, exportName, project, visited }) => {
        const key = "".concat(filePath, ":").concat(exportName);
        if (visited.has(key)) {
          throw new Error(
            'Circular component export while resolving "'.concat(
              exportName,
              '"',
            ),
          );
        ...
        if (typeof source !== "string") {
          throw new Error('Could not read source file "'.concat(filePath, '"'));
        }
        ...
        throw new Error(
          'Could not find composition component "'.concat(exportName, '"'),
        );
      };
      ...
      var resolveCompositionComponentDeclaration = ({
        ...
        if (typeof registrationSource !== "string") {
          throw new Error(
            'Could not read source file "'.concat(registrationFile, '"'),
          );
        }
        ...
        if (!composition) {
          throw new Error(
            'Could not find composition "'.concat(compositionId, '"'),
          );
        }
        const lazyImport = findLazyImport(
          getAttribute(composition, "lazyComponent"),
        );
        ...
        if (lazyImport) {
          ...
          if (!componentName) {
            throw new Error(
              'Could not find a component prop for composition "'.concat(
                compositionId,
                '"',
              ),
            );
        ...
        const source = normalizedFile.startsWith("".concat(normalizedRoot, "/"))
